...
function App() {
  ...
  const provider = usePublicClient({ chainId: selectedNetworkId });
  ...
  return (
    <WagmiConfig config={wagmiConfig} >
      ...
      <div className="App">
        {/* <ExampleReactNpmModule backgroundColor='#D0D0D0' height='10rem' ethereumProvider={provider} /> */}
        <h1>React app</h1>
        <ConnectButton />
        {/* <button onClick={() => {console.log('state of wallet', address, selectedNetworkId)}} >Get wallet details</button> */}
